...
const ExplainWrapper = ({ finishExplain }) => {
  ...
  const position = [
    ...
    },
    {
      ...
      top: { top: 0, left: 0, width: '270px', height: '298px' },
      bottom: { top: '349px', left: 0, width: '270px', height: height - 350 },
      left: { top: -20000, left: -20000, width: '100%', height: '100%' },
      right: { top: 0, left: '270px', width: width - 270, height: '100%' },
    },
    {
      msgBox: { top: 350, left: 300 },
      top: { top: 0, left: 0, width: '270px', height: '349px' },
      bottom: { top: '399px', left: 0, width: '270px', height: height - 399 },
      left: { top: -20000, left: -20000, width: '100%', height: '100%' },
      right: { top: 0, left: '270px', width: width - 270, height: '100%' },
    },
    {
      msgBox: { top: 398, left: 300 },
      top: { top: 0, left: 0, width: '270px', height: '400px' },
      bottom: { top: '450px', left: 0, width: '270px', height: height - 450 },
      left: { top: -20000, left: -20000, width: '100%', height: '100%' },
      right: { top: 0, left: '270px', width: width - 270, height: '100%' },
    },
    {
      ...
      bottom: { top: 171, left: 0, width: '100%', height: height - 169 > 208 ? height - 171 : 208 },
      left: { top: 90, left: 0, width: 295, height: 81 },
      right: { top: 90, left: height - 169 > 208 ? width - 25 : width - 42, width: 25, height: 81 },
    },
    {
      msgBox: { top: 300, left: (width - 55) / 2 },
      top: { top: 0, left: 0, width: '100%', height: 231 },
      bottom: { top: 287, left: 0, width: '100%', height: height - 287 > 208 ? height - 287 : 208 },
      left: { top: 231, left: 0, width: 295, height: 56 },
      right: { top: 231, left: height - 285 > 208 ? width - 25 : width - 42, width: 25, height: 56 },
    },
  ];
  const titleArr = [
    '모마토란?',
